package net.bersanito.mccourse.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import net.fabricmc.fabric.api.client.screen.v1.Screens;
import net.fabricmc.fabric.api.transfer.v1.fluid.FluidConstants;
import net.bersanito.mccourse.MCCourseMod;
import net.bersanito.mccourse.screen.renderer.EnergyInfoArea;
import net.bersanito.mccourse.screen.renderer.FluidStackRenderer;
import net.bersanito.mccourse.util.MouseUtil;
