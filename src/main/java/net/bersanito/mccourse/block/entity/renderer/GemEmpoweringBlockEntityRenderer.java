package net.bersanito.mccourse.block.entity.renderer;

import net.bersanito.mccourse.block.custom.GemEmpoweringStationBlock;
import net.bersanito.mccourse.block.entity.GemEmpoweringStationBlockEntity;
